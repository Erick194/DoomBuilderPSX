...
namespace CodeImp.DoomBuilder.Rendering
{
	public sealed class ColorCollection
	{
		...
		internal ColorCollection(Configuration cfg)
		{
			...
			//mxd. Set new colors (previously these were defined in BuilderPSX.default.cfg)
			...
			//mxd. Set the rest of new colors (previously these were also defined in BuilderPSX.default.cfg)
