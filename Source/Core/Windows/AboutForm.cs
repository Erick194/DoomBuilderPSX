...
namespace CodeImp.DoomBuilder.Windows
{
	internal partial class AboutForm : DelayedForm
	{
		...
		//[GEC]
		private void MasterEditionlink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
		{
			General.OpenWebsite("https://www.doomworld.com/forum/topic/101161/");
		}

		//[GEC]
		private void gitBuilderPSXlink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
		{
			General.OpenWebsite("https://github.com/Erick194/BuilderPSX");
		}

		//[GEC]
		private void gitPsyDoomlink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
		{
			General.OpenWebsite("https://github.com/BodbDearg/PsyDoom");
		}
