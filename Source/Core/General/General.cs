...
namespace CodeImp.DoomBuilder
{
	public static class General
	{
		...
		// Files and Folders
		private const string SETTINGS_FILE = "BuilderPSX.cfg";
		private const string DEFAULT_SETTINGS_FILE = "BuilderPSX.default.cfg"; //mxd
		private const string SETTINGS_DIR = "Doom Builder";
		private const string LOG_FILE = "BuilderPSX.log";
