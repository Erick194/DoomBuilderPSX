...
namespace CodeImp.DoomBuilder.ColorPicker
{
	public class BuilderPlug : Plug
	{
		...
		public override void OnMapOpenEnd() 
		{
            ...
            if(!General.Map.PSXDOOM) toolsform.Register();//[GEC]
        }
		...
		public override void OnMapCloseEnd() 
		{
            ...
            if(!General.Map.PSXDOOM) toolsform.Unregister();//[GEC]
        }
		...
		{
			if(General.Editing.Mode == null || General.Map.DOOM || General.Map.PSXDOOM) return;//[GEC]
