...
namespace CodeImp.DoomBuilder.BuilderModes
{
	...
	public class FieldDescription : Attribute
	{
        ...
        public bool PSXDOOM { get { return psxdoom; } set { psxdoom = value; } }//[GEC]
		...
		public bool SupportsCurrentMapFormat
		{
			get
			{
				...
				return (General.Map.DOOM && doom || General.Map.HEXEN && hexen || General.Map.UDMF && udmf || General.Map.PSXDOOM && psxdoom);//[GEC]
			}
		}
	}
	...
	public class VertexPropertiesCopySettings : MapElementPropertiesCopySettings
	{
		...
		[FieldDescription(Description = "Custom fields", DOOM = false, HEXEN = false, PSXDOOM = false)]
	...
	public class SectorPropertiesCopySettings : MapElementPropertiesCopySettings
	{
		...
		[FieldDescription(Description = "Floor slope", DOOM = false, HEXEN = false, PSXDOOM = false)]
		public bool FloorSlope = true;

		[FieldDescription(Description = "Ceiling slope", DOOM = false, HEXEN = false, PSXDOOM = false)]
	...
	public class SidedefPropertiesCopySettings : MapElementPropertiesCopySettings
	{
		...
		[FieldDescription(Description = "Flags", DOOM = false, HEXEN = false, PSXDOOM = false)]
		public bool Flags = true;
	...
	public class LinedefPropertiesCopySettings : MapElementPropertiesCopySettings
	{
		...
		[FieldDescription(Description = "Action arguments", DOOM = false, PSXDOOM = false)]
		public bool Arguments = true;
		
		[FieldDescription(Description = "Activation", DOOM = false, UDMF = false, PSXDOOM = false)]
	...
	public class ThingPropertiesCopySettings : MapElementPropertiesCopySettings
	{
		...
		[FieldDescription(Description = "Z-height", DOOM = false, PSXDOOM = false)]
		public bool ZHeight = true;
		
		[FieldDescription(Description = "Pitch", DOOM = false, HEXEN = false, PSXDOOM = false)]
		public bool Pitch = true;
		
		[FieldDescription(Description = "Roll", DOOM = false, HEXEN = false, PSXDOOM = false)]
		public bool Roll = true;
		
		[FieldDescription(Description = "Scale", DOOM = false, HEXEN = false, PSXDOOM = false)]
		public bool Scale = true;
		
		[FieldDescription(Description = "Action", DOOM = false, PSXDOOM = false)]
		public bool Action = true;
		
		[FieldDescription(Description = "Action arguments", DOOM = false, PSXDOOM = false)]
		public bool Arguments = true;
		
		[FieldDescription(Description = "Tag", DOOM = false, PSXDOOM = false)]
		public bool Tag = true;
